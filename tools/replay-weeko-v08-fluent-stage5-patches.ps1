...
$stage4Script = Join-Path $PSScriptRoot "replay-weeko-v08-fluent-stage4-patches.ps1"

& $stage4Script -ProjectPath $project
if (!$?) { throw "Fluent Stage 4 patch replay failed; Fluent Stage 5 was not applied." }

function Replace-FluentStage5ExactText {
    param(
...
Replace-FluentStage5ExactText "apktool.yml" @'
  versionCode: 7
...
Write-Output "Applied Fluent UI Stage 5 regression-build marker to $project"
