...
$text = $text.Replace("build\v1.1.0", "build\v1.1.2")
$text = $text.Replace("build-weeko-v11-debug.ps1", "build-weeko-v112-debug.ps1")
$text = $text.Replace("Weeko-v1.1.0", "Weeko-v1.1.2")
$text = $text.Replace("v1.1.0-release-summary.txt", "v1.1.2-release-summary.txt")
$text = $text.Replace("versionCode='14'", "versionCode='16'")
$text = $text.Replace("versionCode=14", "versionCode=16")
$text = $text.Replace("1.1.0", "1.1.2")
$generated = Join-Path $root "tools\.build-weeko-v112-release-generated.ps1"
...
try {
    ...
    if ($LASTEXITCODE -ne 0) { throw "Weeko v1.1.2 release build failed." }
} finally {
